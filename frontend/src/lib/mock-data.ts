...
export const defaultStrategyConfig: StrategyConfig = {
  ...
  blockedHoursUtc: ['22:00-01:00', '16:00-17:00'],
  ...
  allInRecovery: {
    ...
    recoveryContractType: 'accumulator' as const,
